...
import com.example.kapil.hackteam.fragments.OrderFragment;
import com.example.kapil.hackteam.fragments.SubscriptionFragment2;
import com.example.kapil.hackteam.fragments.SummaryFragment;
...
public class PassbookActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        public Fragment getItem(int position) {
            if(position == 1) return new OrderFragment();
            else return new SummaryFragment();
        }
